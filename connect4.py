...
def minimax(board, depth, alpha, beta, maximizingPlayer):   # minimax algorithm  implementation
	valid_locations = get_valid_locations(board)
	is_terminal = is_terminal_node(board)
	if depth == 0 or is_terminal:    #terminal winning is us winnnigng ,opp winning or draw
		if is_terminal:
...
while not game_over:
	...
	if turn == AI and not game_over:				
		...
		col, minimax_scre = minimax(board, 5, -math.inf, math.inf, True)
